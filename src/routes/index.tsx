  ...
  head: () => ({
    meta: [
      { title: "Video Speed Reader — 讓每一段聲音都能被讀懂" },
      {
        name: "description",
        content:
          "上傳影片，快速取得乾淨、可編輯的中英文逐字稿。為內容創作者、教育工作者與工程團隊打造。",
      },
      { property: "og:title", content: "Video Speed Reader" },
      { property: "og:description", content: "上傳影片，快速取得乾淨、可編輯的中英文逐字稿。" },
    ...
    <div className="landing-page">
      <header className="landing-header">
        <div className="landing-nav">
          <Link to="/" className="landing-brand" aria-label="Video Speed Reader 首頁">
            <BrandMark />
      ...
      <main>
        ...
        <section className="closing-section">
          ...
          <h2>下一段影片，從這裡開始。</h2>
          <Link to="/auth" className="closing-link">
